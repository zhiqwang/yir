...
struct Attr {
  ...
  void set_ints2d(const std::vector<std::vector<int64_t>> ints2d_, bool clean_up = false) {
    if (clean_up)
      delete ints2d;
  ...
  void set_strings(const std::vector<std::string> strings_, bool clean_up = false) {
    if (clean_up)
      delete strings;
  ...
  void set_map_str_str(const MapStrStr map_str_str_, bool clean_up = false) {
    if (clean_up)
      delete map_str_str;

...
class Layer:
    ...
    def _set_xlayer(self, _xlayer):
        assert isinstance(_xlayer, lpx.Layer)
    ...
    def subgraph_data(self):
        return [Layer._from_xlayer(x) for x in self._xlayer.subgraph_data]
        # return make_any_vector(Layer._from_xlayer, lpx.XLayerVector)(
    ...
    @property
    def attrs(self):
        return AttrDict(self._xlayer.attrs)
